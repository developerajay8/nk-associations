      ...
      <div className="fixed bottom-6 right-5 z-[999] flex flex-col items-end gap-3">
        ...
        {expanded && (
          <div className="flex flex-col items-end gap-2 mb-1">
            ...
            {/* WhatsApp */}
            <a
              href="https://wa.me/919999999999?text=Hello%20NK%20Associates!%20Mujhe%20tax%20consultation%20chahiye."
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 bg-green-500 text-white font-bold px-5 py-3 rounded-full text-sm shadow-lg shadow-green-500/40 hover:-translate-y-0.5 transition-all duration-200"
            >
